...
//-------------------------- Create the world and implement the animation --------------
    ...
    private TransformedObject triangle1, rect1, hex1_L, hex1_R;
    private TransformedObject triangle2, rect2, hex2_L, hex2_R;
    private TransformedObject triangle3, rect3, hex3_L, hex3_R;
    private void createWorld()
    {
        world = new CompoundObject();
        // TODO - create objects and add them to a scene graph
        triangle1 = new TransformedObject(filledTriangle);
        triangle1.setScale(0.90, 2).setColor(Color.blue);
        triangle1.setTranslation(0.9, -2.9);
        rect1 = new TransformedObject(filledRect);
        rect1.setScale(4, 0.28).setColor(Color.red);
        rect1.setTranslation(0.9, -0.77);
        rect1.setRotation(168);
        hex1_L = new TransformedObject(filledPolygon);
        hex1_L.setColor(Color.gray);
        hex1_L.setTranslation(-1, -0.37);
        hex1_R = new TransformedObject(filledPolygon);
        hex1_R.setColor(Color.gray);
        hex1_R.setTranslation(2.8, -1.17);
        ...
        triangle2.setScale(0.6 * offsetScale, 1.6 * offsetScale).setColor(new Color(42,120,18));
        triangle2.setTranslation(-1 * offsetScale + offsetX, -2.13 * offsetScale + offsetY);
        rect2 = new TransformedObject(filledRect);
        rect2.setScale(3.5 * offsetScale, 0.1 * offsetScale).setColor(Color.darkGray);
        rect2.setTranslation(-1 * offsetScale + offsetX, -0.5 * offsetScale + offsetY);
        rect2.setRotation(168);
        hex2_L = new TransformedObject(filledPolygon);
        hex2_L.setScale(1 * offsetScale, 1 * offsetScale).setColor(Color.gray);
        hex2_L.setTranslation(-2.7 * offsetScale + offsetX, -0.15 * offsetScale + offsetY);
        hex2_R = new TransformedObject(filledPolygon);
        hex2_R.setScale(1 * offsetScale, 1 * offsetScale).setColor(Color.gray);
        hex2_R.setTranslation(0.65 * offsetScale + offsetX, -0.85 * offsetScale + offsetY);
        ...
        triangle3.setScale(1.20 * offsetScale, 3.3 * offsetScale).setColor(new Color(145,17,133));
        triangle3.setTranslation(-1 * offsetScale + offsetX, -5.5 * offsetScale + offsetY);
        rect3 = new TransformedObject(filledRect);
        rect3.setScale(6 * offsetScale, 0.25 * offsetScale).setColor(Color.black);
        rect3.setTranslation(-1 * offsetScale + offsetX, -2.1 * offsetScale + offsetY);
        rect3.setRotation(168);
        hex3_L = new TransformedObject(filledPolygon);
        hex3_L.setScale(1.7 * offsetScale, 1.7 * offsetScale).setColor(Color.gray);
        hex3_L.setTranslation(-3.9 * offsetScale + offsetX, -1.5 * offsetScale + offsetY);
        hex3_R = new TransformedObject(filledPolygon);
        hex3_R.setScale(1.7 * offsetScale, 1.7 * offsetScale).setColor(Color.gray);
        hex3_R.setTranslation(1.8 * offsetScale + offsetX, -2.7 * offsetScale + offsetY);
    ...
    public void updateFrame() {
        ...
        hex1_R.setRotation(frameNumber * 0.9);
        hex1_L.setRotation(frameNumber * 0.9);
        hex2_R.setRotation(frameNumber * 0.9);
        hex2_L.setRotation(frameNumber * 0.9);
        hex3_R.setRotation(frameNumber * 0.9);
        hex3_L.setRotation(frameNumber * 0.9);
    }
...
//--------------------------------- Implementation ------------------------------------
     ...
     * @param ybottom requested y-value at bottom of drawing area; can be less than ytop, which
    will
